<cfif len(trim(form.password)) is not 0>

	<cfquery name="access" datasource="#dsn#">
	select classid from classes
	where classes.password = '#form.password#' and classes.classid = '#session.usern#'
	</cfquery>

	<cfif access.recordcount is not 0>
		<cfset session.loggedin="1">
		<cfset session.loggedinid="#access.classid#">
		<cflocation url="audioreserves.cfm?classid=#access.classid#" addtoken="No">
	</cfif>
...
<link rel="apple-touch-icon-precomposed" href="//www.library.ucla.edu/sites/all/themes/omega/omega/apple-touch-icon-precomposed-144x144.png" sizes="144x144" />
<link rel="apple-touch-icon-precomposed" href="//www.library.ucla.edu/sites/all/themes/omega/omega/apple-touch-icon-precomposed.png" />
<link rel="apple-touch-icon-precomposed" href="//www.library.ucla.edu/sites/all/themes/omega/omega/apple-touch-icon-precomposed-72x72.png" sizes="72x72" />
<link rel="apple-touch-icon-precomposed" href="//www.library.ucla.edu/sites/all/themes/omega/omega/apple-touch-icon-precomposed-114x114.png" sizes="114x114" />
<meta name="MobileOptimized" content="width" />
<meta name="HandheldFriendly" content="true" />
<link rel="canonical" href="/music" />
<meta name="Generator" content="Drupal 7 (http://drupal.org)" />
<link rel="shortlink" href="/node/375" />
<link rel="shortcut icon" href="//www.library.ucla.edu/sites/all/themes/uclalib_omega/favicon.ico" type="image/vnd.microsoft.icon" />
...
<p><font face="Verdana, Arial, Helvetica, sans-serif">The password you entered is not the correct one for this class.</font></p>

<p><font face="Verdana, Arial, Helvetica, sans-serif">You may <a href="eresaccess.cfm" style="text-decoration: none">return 
to the previous page</a> and try again, or return to the <a href="current.cfm?=1">Audio Reserves home page</a>.</font></p>

<p><font face="Verdana, Arial, Helvetica, sans-serif">If you do not know the password
for your class please contact your instructor.</font></p>
