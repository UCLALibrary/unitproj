...
<cfif IsDefined("Session.finalVerify")>
	<cfif URL.pwd EQ Session.finalVerify>
		...
		<cflocation url="http://unitdev.library.ucla.edu/cataloging/test/webtool4.cfm" addToken="No">
	<cfelse>
		<cflocation url="http://unitdev.library.ucla.edu/cataloging/test/randimage/randimage4.cfm">
	</cfif>
<cfelse>
	Session expired... <br>
