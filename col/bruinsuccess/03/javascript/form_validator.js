...
var naRec = new validation('the name of person the grade should be sent to', 'naRec', 'text', 'isText(str)', null);
var emailRec = new validation('email address', 'emailRec', 'text', 'isEmail(str)', null);
var naSend = new validation('your name', 'naSend', 'text', 'isText(str)', null);
var emailSend = new validation('email address', 'emailSend', 'text', 'isEmail(str)', null);
