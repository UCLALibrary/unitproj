...
<!-- previous button -->
<a href="0702.cfm"><img src="images/02_previous.gif" alt="Previous" width="92" height="43" border="0" class="prev"></a>
<!-- end left column -->
  </td>
  <td align="center">
...
<p>
<span class="quiz_number">Question 3 of 5:</span>
...
<div class="quiz_a">
 <div id="q1a">
<p>
Actually, it depends. Sharing notes using file sharing programs is currently being contested, so there's no clear-cut answer for this now. But obviously, downloading someone's term paper to turn in as your own for a class is definitely not OK.
</p>
 </div>
 <div id="q1b">
<p>
...
<!-- next button -->
<a href="0704.cfm"><img src="images/02_next.gif" alt="Next" width="68" height="44" border="0" class="next"></a>
