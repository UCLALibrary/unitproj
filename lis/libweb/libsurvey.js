// Polyfill for IE, which doesn't support the ECMA 2016 Array.includes() method.
// Verbatim from https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/includes
...
function isSurveyTime() {
	...
	switch (host) {
		...
		case 'www-test.library.ucla.edu':
			testTimes.push([Date.parse("Sep 14 2018 00:00 PDT"), Date.parse("Sep 16 2018 23:00 PDT")]);
			break;
		// no default
	}
