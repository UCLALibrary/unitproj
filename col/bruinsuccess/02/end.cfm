...
<style type="text/css">	<!--
	body {
		background-image: url(images/02_background1.gif);
	}
	-->
</style>
</head>
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
 <tr>
  <td></td>
  <td align="center"><img src="images/02_finished.gif" alt="Finished!" width="162" height="106" border="0" style="margin: 10px 0 10px 0;"></td>
  <td></td>
 </tr>
 <tr valign="top">
...
<!-- previous button -->
<a href="09.cfm"><img src="images/02_previous.gif" alt="Previous" width="93" height="43" border="0" class="prev"></a>
<!-- end left column -->
  </td>
  <td>
   <table width="426" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
     <td><img src="images/02_border_top.gif" width="426" height="19"></td>
    </tr>
    <tr>
     <td background="images/02_border.gif">
<div class="copy">
<!-- begin content -->
...
<ul>
<li><strong>2. Need a File, Share a File</strong></li>
</ul>
...
<li>2. Need a File, Share a File</li>
...
<!-- end content -->
    ...
    <tr>
     <td><img src="images/02_border_bottom.gif" width="426" height="19"></td>
    </tr>
