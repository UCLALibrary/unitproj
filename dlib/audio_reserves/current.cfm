...
<cfquery name="currentclasses" datasource="#dsn#">
select instructor, department, classnumber, title, classid,
	currentquarter.year, currentquarter.quarter, password
	from instructors, classes, currentquarter
	...
	order by department,instructor,classnumber
</cfquery>
...
<h3><cfoutput query="currentclasses" startrow=1 maxrows=1>#ucase(currentclasses.quarter)# #currentclasses.year#</cfoutput></h2>
