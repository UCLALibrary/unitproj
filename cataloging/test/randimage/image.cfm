...
<cfset randNums1 = RandRange(1000,99999)>
...
<cfset Session.finalVerify = "#randAlpha1##randAlpha2##randAlpha3##randAlpha4#">
...
<cfset fontDetails.fontfile = "#ExpandPath(".")#/fonts/cour.ttf">
...
--->
<cfset imgAddText = imageCFC.addtext("", "#ExpandPath(".")#/Images/bgdigits.jpg", "#ExpandPath(".")#/Images/bgdigits2.jpg", 70, 0, fontDetails, "#Session.finalVerify#")>
...
<cfcontent file="#ExpandPath(".")#/Images/bgdigits2.jpg" deletefile="yes">
</body>
</html>
